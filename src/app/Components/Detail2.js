...
export default function ProductDetail2({product}) {
            ...
            <section className="py-10 bg-[#fef7f4]  ">
                <div className="container mx-auto px-4">
                    ...
                    <nav className="text-sm text-[#202c33]/70 mb-8">
                        <a href="#" className="mx-2 hover:underline">{product.data.Category}</a>
                    </nav>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white flex justify-center items-center">
                            <img
                                src={product.data["Image URL"]} // Replace with the actual image path
                        ...
                        {/* Product Info */}
                        <div>
                            <h1 className="text-3xl font-semibold text-[#202c33]">{product.data.Name}</h1>
                            <h3 className="text-2xl font-semibold text-[#202c33]/90 mt-4">{product.data.Price}</h3>
                            <p className="text-[#202c33] mt-3 leading-relaxed">
                            ...
                            <div className="border border-[#4F4F4F80]/50 rounded bg-none">
                                <div className="flex items-center gap-2 py-4 px-3">
                                    ...
                                    <span className="text-gray-700">{product.data.Availability}</span>
                                </div>
                                <div className="flex items-center gap-2 py-4 px-3 border-t border-[#4F4F4F80]/50">
                                    ...
                                    <span className="flex items-center gap-2">
                                        <span className="text-gray-700">{product.data.Brand.Name}</span>
                                    </span>
                                </div>
                            </div>
                        </div>
...
<path d="M4.27375 36.25H35.725C38.0863 36.25 40 34.3362 40 31.9762V8.02375C40 5.66375 38.0863 3.75 35.7262 3.75H4.27375C1.91375 3.75 0 5.66375 0 8.02375V31.975C0 34.3363 1.91375 36.25 4.27375 36.25ZM1.25 8.02375C1.25 6.35625 2.60625 5 4.27375 5H35.725C37.3937 5 38.75 6.35625 38.75 8.02375V31.975C38.75 33.6437 37.3937 35 35.7262 35H4.27375C2.60625 35 1.25 33.6437 1.25 31.9762V8.02375Z" fill="black"/>
                        ...
                        <p className="text-[#202c33] mt-3 mb-5 leading-relaxed">
                                {product.data.Description}
                            </p>
                    </div>
                </div>
